    ...
    <div className="md:w-main md:h-[110px] md:py-[35px] md:flex md:justify-between justify-center w-full">
                ...
                {products?.map((el) => (
                  <div
                    ...
                    onClick={(e) => {
                      e.stopPropagation();
                      navigate(
                        `/products/${el?.category[0]}/${el?._id}/${el?.title}`
                      );
                      queries.q = "";
                    }}
                  >
                    ...
                    <div className="flex flex-col gap-2 ml-4">
                      <span className="font-medium text-sm text-main truncate max-w-[200px]">
                        {el.title}
                      </span>
      ...
      <Link to={`/${path.HOME}`}>
        <img
          src={logo}
          alt="logo"
          className="w-[80px] h-[80px] object-contain hidden md:block"
        ></img>
      </Link>
        ...
        {current && (
          <>
            ...
            >
              ...
              <span className="hover:text-[#79AC78] pt-1 block md:hidden">{`${
                current?.cart?.length || 0
              }`}</span>
            </div>
          </>
