  ...
  return (
    <div className="w-full">
      ...
      <div className="md:w-main w-full mx-auto my-4">
        <h2 className="text-main text-3xl font-bold text-center py-4">
          THÔNG TIN LIÊN HỆ
        </h2>
        <p className="text-center text-gray-600 text-sm my-4">
          Cảm ơn bạn đã quan tâm đến sản phẩm của chúng tôi. Để đặt lịch tư vấn,
          bạn vui lòng điền thông tin vào mẫu đơn bên trái hoặc điền đơn “đề
          nghị tư vấn” online. Chuyên viên tư vấn của chúng tôi sẽ liên hệ với
        ...
        <div className="flex md:flex-row flex-col items-center">
          <div className="flex-1 flex flex-col gap-2 items-center  p-4">
            ...
            <span className="text-[#333333] text-[18px] uppercase font-bold">
              hotline
            </span>
          ...
          <div className="flex-1 flex flex-col gap-2 items-center  p-4">
            ...
            <span>baokhanhdeptrai@gmail.com</span>
          </div>
        </div>
        <div className="my-6">
          <section class="bg-gray-100 rounded-md">
            <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
              ...
              <p class="mb-8 lg:mb-16 font-light text-center text-gray-500 sm:text-xl">
                Có một vấn đề kỹ thuật? Bạn muốn gửi phản hồi về tính năng ? Cần
                thông tin chi tiết về kế hoạch kinh doanh của chúng tôi? Hãy cho
                chúng tôi biết.
              </p>
