...
export const adminSidebar = [
  ...
  },
  {
    ...
    submenu: [
      {
        text: "Tạo phiếu nhập",
        path: `/${path.ADMIN}/${path.CREATE_RECEIPT}`,
        icon: <IoCreateOutline size={20} />,
      },
      {
        text: "Quản lý phiếu nhập",
  ...
  },
  {
    ...
    submenu: [
      {
        text: "Tạo dịch vụ",
        path: `/${path.ADMIN}/${path.CREATE_SERVICE}`,
        icon: <IoCreateOutline size={20} />,
      },
      {
        text: "Quản lý dịch vụ",
  ...
  },
  {
    ...
    submenu: [
      {
        text: "Tạo sự kiện",
        path: `/${path.ADMIN}/${path.CREATE_SALE}`,
        icon: <IoCreateOutline size={20} />,
      },
      {
        text: "Quản lý sự kiện",
  ...
  },
  {
    ...
    submenu: [
      {
        text: "Tạo nội dung",
        path: `/${path.ADMIN}/${path.CREATE_CONTENT}`,
        icon: <IoCreateOutline size={20} />,
      },
      {
        text: "Quản lý nội dung",
...
export const feedbackUser = [
  {
    id: 1,
    src:
      "https://globalcheck.com.vn/apt-upload/image/data/Reivew/riew-khach-3.jpg" ||
      "https://globalcheck.com.vn/apt-upload/image/data/baner-(2).png",
  },
  {
    id: 2,
